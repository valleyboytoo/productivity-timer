...
Original file is located at
    https://colab.research.google.com/drive/12CwcEOWGFny6lySjTiTM4364XtkYcujp
"""
...
class ProductivityTimerApp:
    ...
    def build_ui(self):
        ...
        # Changed text x-position from 180 to 200 (center)
    ...
    def draw_progress(self, fraction):
        ...
        # Coords adjusted for 400x360 canvas (from 20,20,340,340)
        x0, y0, x1, y1 = 40, 20, 360, 340;

        start = -90
        extent = int(360 * fraction)
